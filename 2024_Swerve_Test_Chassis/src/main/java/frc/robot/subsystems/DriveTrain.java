...
public class DriveTrain extends SubsystemBase {
  ...
  // The gyro sensor
  private final Pigeon2 m_gyro = new Pigeon2(GlobalConstants.pigeonID);
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative, boolean rateLimit) {
    ...
    double xSpeedDelivered = xSpeedCommanded * DriveConstants.maxSpeedMPS;
    double ySpeedDelivered = ySpeedCommanded * DriveConstants.maxSpeedMPS;
    double rotDelivered = m_currentRotation * DriveConstants.maxAngularSpeed;

    var swerveModuleStates = DriveConstants.swerveKinematics.toSwerveModuleStates(
        fieldRelative
    ...
    SwerveDriveKinematics.desaturateWheelSpeeds(
        swerveModuleStates, DriveConstants.maxSpeedMPS);
  ...
  public double getTurnRate() {
    return m_gyro.getRate() * (DriveConstants.reverseGyro ? -1.0 : 1.0);
  }
}
